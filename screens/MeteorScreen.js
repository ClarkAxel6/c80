...
import { StyleSheet, Text, View, Alert, SafeAreaView, Platform, StatusBar, FlatList, ImageBackground, Dimensions, Image } from 'react-native';
...
export default class MeteorScreen extends React.Component {
  ...
  getMeteors = () => {
    axios
      .get('https://api.nasa.gov/neo/rest/v1/feed?api_key=N5Y4c6cTL5AXZpP73icshHXhVAvFZvf0sgJbfILk')
        ...
        <ImageBackground source={bg_img}
          ...
          <View style={styles.gifContainer}>
            ...
            <View>
              ...
              <Text style={[styles.cardText, { marginTop: 5, marginLeft: 50 }]}> Minimun Diameter (km) - {item.estimated_diameter.kilometers.estimated_diameter_min}</Text>
